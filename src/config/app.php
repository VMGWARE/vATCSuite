...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This value is the voice engine used for text-to-speech.
    |
    */
    'voice-engine' => env('VOICE_ENGINE', 'VoiceRSS'),
    ...
    */
    ...
    |
    */
    'version'  => \Tremby\LaravelGitVersion\GitVersionHelper::getVersion() ?? 'dev',
